...
namespace BJCBCPOS
{
    public partial class UCListCheckProduct : UserControl
    {
        private int _cntCount;

        public UCListCheckProduct()
        {
            InitializeComponent();
        }

        public UCListCheckProduct(int cntCount)
        {
            InitializeComponent();
            _cntCount = cntCount;
        }

        private void UCListCheckProduct_Load(object sender, EventArgs e)
        {
