...
namespace BJCBCPOS
{
    public partial class UCHamberger : UserControl
    {
        [Category("Action")]
        ...
        public UCHamberger(DataTable dt)
        {
            InitializeComponent();
            _dt = dt;
        }
        ...
        private void UCHamberger_Load(object sender, EventArgs e)
        {
            ...
            {
                UCHambergerItem ucHambItm = new UCHambergerItem();
                ...
                if (_dt.Select(" ReferMenuID = '" + dr["MenuID"].ToString() + "'").Length > 0)                
                {
                    ...
                    {
                        UCHambergerItem ucHambItm2 = new UCHambergerItem();
        ...
        private void ucHambItm_HambergerSubMenuItemClick(object sender, EventArgs e, string refMenuID, string menuName)
        {
            ...
            var ucSubMenu = new UCHambergerSubMenu(_dt, refMenuID, menuName);
        ...
        private void ExpandItemClick(object sender, EventArgs e, Panel pn)
        {
            ...
            UCHambergerItem ucHambItm = (UCHambergerItem)sender;
            if (pn.Visible)
            {
