...
namespace BJCBCPOS.OtherServices {
    ...
    public partial class frmBigService : Form {
        ...
        void iconList() {
            var fi = new System.IO.DirectoryInfo(Application.StartupPath + "\\images\\icons");
            listView1.View = View.LargeIcon;
            imageListM.ColorDepth = ColorDepth.Depth32Bit;
            imageListM.ImageSize = new Size(120,110);

            foreach(var item in fi.GetFiles()) {
                imageListM.Images.Add(Image.FromFile(item.FullName));
            }
