...
namespace BJCBCPOS.OtherServices.UserControls {
    ...
    public class DeftsfotToggle : Control {
        private float diameter;
        private ToggleRectangle rect;
        ...
        public DeftsfotToggle() {
            this.Cursor = Cursors.Hand;
            this.DoubleBuffered = true;
            this.artis = 4f;
            this.diameter = 30f;
            this.textEnabled = true;
            this.rect = new ToggleRectangle(2f * this.diameter,this.diameter + 2f,this.diameter / 2f,1f,1f);
        ...
        protected override void OnPaint(PaintEventArgs e) {
            ...
            if(base.Enabled) {
                ...
                if(this.textEnabled) {
                    ...
                    using(SolidBrush brush2 = new SolidBrush("#FFFFFF".ColorFromHex())) {
                    ...
                    using(SolidBrush brush3 = new SolidBrush("#FFFFFF".ColorFromHex())) {
                        using(SolidBrush brush4 = new SolidBrush("#FFFFFF".ColorFromHex())) {
        ...
        [Category("Deftsoft Control"), Description("Toggle button Show or hide Text")]
        ...
        [Category("Deftsoft Control"), Description("Toggle button on")]
        public bool IsOn {
            get =>
                this.isON;
            set {
        ...
        [Category("Deftsoft Control"), Description("Toggle button border color")]
        ...
        [Category("Deftsoft Control"), Description("Toggle button On Text")]
        ...
        [Category("Deftsoft Control"), Description("Toggle button Off Text")]
        ...
        [Category("Deftsoft Control"), Description("Toggle button On Color")]
        ...
        [Category("Deftsoft Control"), Description("Toggle button Off Color")]
    ...
    internal class ToggleRectangle {
        ...
        public ToggleRectangle() { }
        public ToggleRectangle(float width,float height,float radius,float x = 0f,float y = 0f) {
    ...
    internal static class ToggleExtension {
        public static Color ColorFromHex(this string hex) => ColorTranslator.FromHtml(hex);
    }
}
