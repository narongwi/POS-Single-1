...
namespace BJCBCPOS.OtherServices {
    public partial class frmAirTicket : Form
    {
        ...
        public int main_menu = 5;
        public int sub_menu = 15;
        ...
        private void AirTicket_Load(object sender, EventArgs e)
        {
        ...
        private void deftsoftButton2_Click(object sender, EventArgs e)
        {
            Array.Clear(imgfileM, 0, imgfileM.Length);
            Array.Clear(imgfileC, 0, imgfileC.Length);
            Array.Clear(menuNameM, 0, menuNameM.Length);
